...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| EE 2002 | Engineering Math - Differential Equation | A+ | 4.3 | 3 | Tian-Wei Huang |
| EE 2003 | Engineering Math - Complex Variables | A | 4.0 | 2 | Huei Wang |
| EE 2007 | Probability and Statistics | B+ | 3.3 | 3 | Chun-Ting Chou |

### Electronics & Circuits
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| EE 2004 | Electronic Circuits | A+ | 4.3 | 3 | Hsin-Shu Chen |
| EE 2009 | Electronics (Ⅰ) | A | 4.0 | 3 | Chao-Hsin Wu |
| EE 2013 | Electronics(Ⅱ) | A- | 3.7 | 3 | Shen-Iuan Liu |
| EE 2012 | Switching Circuit and Logic Design | A- | 3.7 | 3 | An-Yeu (Andy) Wu |

### Signal Processing & Systems
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| EE 2011 | Signals and System | A | 4.0 | 3 | Feng-Li Lian |
| EE 5141 | Digital Signal Processing VLSI Design | B+ | 3.3 | 3 | Shao-Yi Chien |
...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| EE 3013 | Solid State Electronics | A+ | 4.3 | 3 | Jenn-Gwo Hwu |
| EE 4032 | Semiconductor Engineering | A+ | 4.3 | 3 | Chih-Ting Lin |
| EE 5018 | Solid State Physics (Ⅰ) | A- | 3.7 | 3 | Hao-Hsiung Lin |
| EE 5113 | Physics of Semiconductor Devices | B+ | 3.3 | 3 | Chung-Chih Wu |
| EE 5116 | MOS Capacitor Device | A+ | 4.3 | 3 | Jenn-Gwo Hwu |
...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| MATH 1201 | Calculus (general Mathematics) (a)(1) | A- | 3.7 | 4 | Chin-Lung Wang |
| MATH 1202 | Calculus (general Mathematics) (a)(2) | A | 4.0 | 4 | Chin-Lung Wang |
| MATH 1402 | Computer Programming | A | 4.0 | 3 | P. Y. Ting |
| MATH 2208 | Honors Advanced Calculus (Ⅱ) | A- | 3.7 | 4 | Chin-Lung Wang |
| MATH 2218 | Intro. to Partial Differential Equations | A | 4.0 | 4 | Hsia, C.-H |
...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| Phys 1006 | General Physics (a)(1) | A+ | 4.3 | 3 | Jeng-Da Chai |
| Phys 1007 | General Physics (a)(2) | B+ | 3.3 | 3 | Min-Zu Wang |
| Phys 2004 | Mechanics (1) | A- | 3.7 | 3 | Hsi-Sheng Goan |
| Phys 2005 | Mechanics (2) | A- | 3.7 | 3 | Hsi-Sheng Goan |
| Phys 2019 | Electricity and Magnetism (1) | A | 4.0 | 3 | Jeng-Wei Chen |
| Phys 2020 | Electricity and Magnetism (2) | A | 4.0 | 3 | Jeng-Wei Chen |

### Advanced Physics
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| Phys 3006 | Thermal Physics | A+ | 4.3 | 3 | Guang-Yu Guo |
| Phys 3010 | Introduction to Statistical Physics | A | 4.0 | 3 | Yih-Yuh Chen |
| Phys 7014 | Quantum Mechanics ( I ) | B+ | 3.3 | 4 | Pei-Ming Ho |
...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| ME 2001 | Engineering Mathematics (1) | A+ | 4.3 | 3 | Hsin-Fu Huang |
| ME 2002 | Engineering Mathematics (2) | A+ | 4.3 | 3 | Tzuyin Wu |

### Mechanics & Materials
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| ME 1005 | Statics | A+ | 4.3 | 2 | Shih, Wen-Pin |
| ME 1006 | Dynamics | A+ | 4.3 | 3 | Yee-Pien Yang |
| ME 2003 | Strength of Materials | A+ | 4.3 | 3 | Jia-Yang Juang |
| ME 3102 | Advanced Strength of Materials | A+ | 4.3 | 3 | Jia-Yang Juang |
| ME 5129 | Vibration | A+ | 4.3 | 3 | Lu, Chung-Jen |

### Thermal Sciences
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| ME 2005 | Thermodynamics | A+ | 4.3 | 3 | Yau-Ming Chen |
| ME 2007 | Fluid Mechanics | A+ | 4.3 | 3 | Fu-Ling Yang |
| ME 3003 | Heat Transfer | A+ | 4.3 | 3 | Fan, Shih-Kang |

### Control Systems
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| ME 3007 | Automatic Control | A+ | 4.3 | 3 | Fu-Cheng Wang |
| ME 5220 | Linear Control System | A- | 3.7 | 3 | Fu-Cheng Wang |
| ME 7137 | Robust Control | A | 4.0 | 3 | Fu-Cheng Wang |
...
## Programming & Computer Science Supplements
...
| Course Code | Course Title | Grade | GPA | Credits | Instructor |
|-------------|--------------|-------|-----|---------|------------|
| JpnL 2017 | Japanese (Ⅰ)(1) | A | 4.0 | 3 | 洪淑娟 |
| JpnL 2018 | Japanese (Ⅰ)(2) | A | 4.0 | 3 | 洪淑娟 |
| JpnL 3047 | Japanese (Ⅱ)(1) | A | 4.0 | 3 | 詹兆雯 |
| JpnL 3048 | Japanese (Ⅱ)(2) | A+ | 4.3 | 3 | 詹兆雯 |
| JpnL 4029 | Japanese (Ⅲ)(1) | A+ | 4.3 | 3 | 洪淑娟 |
| JpnL 4030 | Japanese (Ⅲ)(2) | A+ | 4.3 | 3 | 洪淑娟 |
...
- **Strong Performance in Advanced Topics**: Consistent A+ grades in advanced computer science subjects including Deep Learning, Computer Vision, and AI
- **Interdisciplinary Background**: Comprehensive studies across Computer Science, Electrical Engineering, Mathematics, Physics, and Mechanical Engineering
- **Research-Oriented Courses**: Specialized courses in quantum computing, graph algorithms, and biological sequence analysis
- **Programming Proficiency**: Multiple programming languages including Java, Python, C/C++, and R
- **Currently Pursuing**: Master's degree in Computer Science at University of Colorado Boulder with focus on algorithms, computer vision, data mining, and robotics
